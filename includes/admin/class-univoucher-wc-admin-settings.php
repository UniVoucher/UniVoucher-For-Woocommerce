...
class UniVoucher_WC_Admin_Settings {
	...
	public function ajax_test_api_key() {
		...
		if ( isset( $data['result'] ) ) {
			...
			wp_send_json_success( array( 'message' => sprintf( esc_html__( '✅ API key is valid! Connected to %s', 'univoucher-for-woocommerce' ), $network_name ) ) );
		}
