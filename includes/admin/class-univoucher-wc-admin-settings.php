...
class UniVoucher_WC_Admin_Settings {
	...
	public function lmfwc_integration_callback( $args ) {
		...
		<div class="univoucher-settings-box">
			<h4>
				<?php esc_html_e( 'License Manager Integration', 'univoucher-for-woocommerce' ); ?>
			</h4>
			...
			<div class="univoucher-settings-box-info">
				...
				<p style="margin: 10px 0 0 0; font-size: 12px; color: #0c5460;">
					<?php esc_html_e( 'When enabled, UniVoucher gift cards will be displayed alongside license keys in customer-facing pages.', 'univoucher-for-woocommerce' ); ?>
				</p>
			</div>
			...
			<?php if ( ! $lmfwc_active ) : ?>
				<div class="univoucher-settings-box-warning" style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 4px; padding: 12px; margin-top: 15px;">
					...
					<p style="margin: 8px 0 0 0; font-size: 12px; color: #856404;">
						<?php esc_html_e( 'License Manager for WooCommerce plugin is not active. This integration will not work until the plugin is activated.', 'univoucher-for-woocommerce' ); ?>
					</p>
				</div>
			<?php endif; ?>
